\addvspace {10\p@ }
\contentsline {lstlisting}{\numberline {1.1}Syntax einer DOCTYPE-Deklaration}{6}{lstlisting.1.1}
\contentsline {lstlisting}{\numberline {1.2}Syntax einer ELEMENT-Deklaration}{7}{lstlisting.1.2}
\contentsline {lstlisting}{\numberline {1.3}Syntax einer ATTLIST-Deklaration}{8}{lstlisting.1.3}
\contentsline {lstlisting}{\numberline {1.4}Inline-DTD Beispiel}{9}{lstlisting.1.4}
\contentsline {lstlisting}{\numberline {1.5}Listeneintr\IeC {\"a}ge}{10}{lstlisting.1.5}
...
\contentsline {lstlisting}{\numberline {4.2}xsl:apply-templates Syntax}{17}{lstlisting.4.2}
\contentsline {lstlisting}{\numberline {4.3}xsl:value-of Syntax}{17}{lstlisting.4.3}
\contentsline {lstlisting}{\numberline {4.4}xsl:for-each Syntax}{18}{lstlisting.4.4}
\contentsline {lstlisting}{\numberline {4.5}xsl:if Syntax}{18}{lstlisting.4.5}
\contentsline {lstlisting}{\numberline {4.6}xsl:choose Syntax}{18}{lstlisting.4.6}
\contentsline {lstlisting}{\numberline {4.7}xsl:sort Syntax}{19}{lstlisting.4.7}
\contentsline {lstlisting}{\numberline {4.8}xsl:template mit name Syntax}{19}{lstlisting.4.8}
\contentsline {lstlisting}{\numberline {4.9}xsl:call-template Syntax}{19}{lstlisting.4.9}
\contentsline {lstlisting}{\numberline {4.10}Normale xsl:template Syntax}{19}{lstlisting.4.10}
\contentsline {lstlisting}{\numberline {4.11}xsl:variable Syntax}{19}{lstlisting.4.11}
\contentsline {lstlisting}{\numberline {4.12}Beispiel f\IeC {\"u}r Variablendeklaration}{20}{lstlisting.4.12}
\contentsline {lstlisting}{\numberline {4.13}Beispiel f\IeC {\"u}r Variable in Template}{20}{lstlisting.4.13}
