...
% Glossar ===================================================
\usepackage[
	toc, 		% Das Glossar ins TOC eintragen
	numberline,	% Fügt ein numberline im TOC Eintrag hinzu (Name wird bündig zu anderen section-Namen angezeigt und nich bündig zur Kapitelzahl)
	nonumberlist, % Zeigt keine Seitenzahlen an, auf denen die Begriffe vorkommen
	section=chapter, % Eintrag im TOC sitzt auf section-Ebene
	style=altlist, % Dartstellung als Liste, Beschreibung beginnt in nächster Zeile
	hyperfirst=true % Erstes Auftreten ist Hyperlink
]{glossaries}
\usepackage[
	footnote,	% Full names appear in the footnote
%	smaller,	% Print acronym in smaller fontsize
	printonlyused % Nur benutze Akronyme ins Verzeichnis aufnehmen
]{acronym}
...
\lstdefinelanguage{XML}{
  keywords={<?xml, <studi, <studis>, ?>, />, >, </studis>},
  ndkeywords={version, xmlns:xsl, xml, xsl:stylesheet},
  sensitive=false,
  comment=[l]{//},
  morecomment=[s]{<!--}{-->},
  morestring=[b]',
